...
class Internship(models.Model):
    ...
    start_by = models.DateTimeField(default='2000-01-01', help_text='YYYY-MM-DD Format should be followed for the date.')
    duration = models.CharField(max_length=20)
    about = models.TextField()
    location = models.CharField(max_length=100)
    stipend = models.CharField(max_length=100)
    no_of_internships = models.PositiveIntegerField()
    apply_by = models.DateField(default='2021-04-25 16:30:00', help_text='YYYY-MM-DD Format should be followed for the date.')
